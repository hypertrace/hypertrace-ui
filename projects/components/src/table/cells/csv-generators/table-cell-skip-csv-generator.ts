...
@TableCellCsvGenerator({
  type: CoreTableCellCsvGeneratorType.Skip
})
export class TableCellSkipCsvGenerator extends TableCellCsvGeneratorBase<unknown> {
  public generateCsv(_cellData: boolean): undefined {
    return undefined;
  }
}
