...
export const TABLE_CELL_CSV_GENERATOR: InjectionToken<
  CoreTableCellCsvGeneratorType | string | undefined
> = new InjectionToken('TABLE_CELL_CSV_GENERATOR');
...
export const createTableCellInjector = (
  ...
  Injector.create({
    providers: [
      ...
      {
        provide: TABLE_CELL_CSV_GENERATOR,
