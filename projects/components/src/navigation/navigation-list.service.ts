...
import { ApplicationFeatureValues, HtRoute, NavigationService } from '@hypertrace/common';
...
export class NavigationListService {
  ...
  public getNavItemDefinitionForFeature(feature: ApplicationFeatureValues): NavItemConfig {
