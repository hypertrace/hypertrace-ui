  ...
  providers: [
    {
      ...
      useValue: [BooleanFilterBuilder, NumberFilterBuilder, StringFilterBuilder, StringMapFilterBuilder]
    },
    {
      provide: FILTER_PARSERS,
      useValue: [ComparisonFilterParser, InFilterParser, ContainsFilterParser]
    }
  ]
})
