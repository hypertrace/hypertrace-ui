  ...
  providers: [
    {
      ...
      useValue: [
        ...
        { key: IconType.BrowserChrome, url: `${iconsRootPath}/browser-chrome.svg` },
        { key: IconType.BrowserFirefox, url: `${iconsRootPath}/browser-firefox.svg` },
        { key: IconType.BrowserEdge, url: `${iconsRootPath}/browser-edge.svg` },
        { key: IconType.BrowserInternetExplorer, url: `${iconsRootPath}/browser-id.svg` },
        { key: IconType.BrowserSafari, url: `${iconsRootPath}/browser-safari.svg` },
