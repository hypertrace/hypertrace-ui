...
import { CartesianHoverData, CartesianSelectedData, ChartEvent } from './chart-interactivty';
...
export class CartesianChartComponent<TData> implements OnChanges, OnDestroy {
  ...
  public readonly selectionChange: EventEmitter<
    MouseLocationData<TData, Series<TData> | Band<TData>>[] | CartesianSelectedData<TData> | CartesianHoverData<TData>
  > = new EventEmitter();
